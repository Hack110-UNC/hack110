        ...
        <div className="min-h-screen bg-gradient-to-b from-pink-900 via-orange-500 to-teal-300 text-white">
            ...
            <ul className="grid grid-cols-2 sm:flex sm:flex-row sm:gap-8 gap-1 items-center text-lg">
              ...
              <li className="col-span-2 text-center">
                <a href="https://forms.gle/M8X9kedHngwkSej38" target="_blank" rel="noopener noreferrer" className="text-blue-400 font-bold hover:text-blue-300 transition">
                  Sign Up
                </a>
              </li>
            </ul>
            ...
            <section className="h-screen flex items-center justify-center relative overflow-hidden pt-20">
                <div className="container mx-auto px-4 z-10 text-center">
                    ...
                    <a href="https://forms.gle/M8X9kedHngwkSej38" target="_blank" rel="noopener noreferrer" className="px-8 py-4 bg-blue-600 hover:bg-blue-700 rounded-full text-lg font-semibold transition inline-block">
                        Register Now
                    </a>
                </div>
            </section>
